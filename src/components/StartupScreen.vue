...
.logo-wrapper { animation: pulse 1.5s ease-in-out infinite; }
.startup-logo {
...
.startup-status {
  margin-top: 32px; font-size: 14px; color: #999; letter-spacing: 1px;
}
.error-text { color: #e74c3c; }
.retry-btn {
  margin-top: 20px; padding: 8px 28px; border: 1px solid #3288ed;
  border-radius: 6px; background: #fff; color: #3288ed;
  font-size: 14px; cursor: pointer; transition: all 0.2s;
}
.retry-btn:hover { background: #3288ed; color: #fff; }
@keyframes pulse {
